...
public class CooldownHandler {
    private final Map<Player, Long> combatPlayers = new ConcurrentHashMap<>();
    private final Map<Player, Long> gemCooldown = new ConcurrentHashMap<>();
    private final Map<Player, Long> secondaryCooldown = new ConcurrentHashMap<>();
